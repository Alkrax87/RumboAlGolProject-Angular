...
@Component({
  selector: 'app-eliminatorias-fixture',
  templateUrl: './eliminatorias-fixture.component.html',
  styleUrl: './eliminatorias-fixture.component.css'
})
export class EliminatoriasFixtureComponent {
  ...
  getRealResultNorth(teamHome: any, teamAway: any, gameNumber: number): MatchResult {
    const TeamH = teamHome.clasificatoria.find((game: any) => game.game === gameNumber);
    const TeamA = teamAway.clasificatoria.find((game: any) => game.game === gameNumber);
    return {
